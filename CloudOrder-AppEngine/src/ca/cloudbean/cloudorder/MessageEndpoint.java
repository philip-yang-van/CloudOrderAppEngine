package ca.cloudbean.cloudorder;
 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "cloudbean.ca", ownerName = "cloudbean.ca", packagePath="cloudorder"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "200795476479";
